...
<html lang="en">
  <head>
    ...
    <title>Digitrix India -- Certificates</title>
  </head>
  <body >
    <!--navbar-->
    <!--navbar-->
        ...
        <div class="row mt-0 pt-0 " style="overflow-y:hidden;">
            <div class="col-md-6 p-2" data-aos="zoom-out"  data-aos-duration="2000">
                <div class="center-div d-flex flex-column align-items-center">
                  ...
                  <a href="images/GST.png" target="_blank" class="text-light text-decoration-none mt-4 mb-2 ">CERTIFICATE</a>
                </div>
            </div>
            <div class="col-md-6 p-2" data-aos="zoom-out"  data-aos-duration="2000">
                <div class="center-div d-flex flex-column align-items-center">
                  <a href="images/IEC.png" target="_blank">  <img src="images/IEC.png" class="img-fluid imgcertificate" alt="" srcset="">  </a>
                  <a href="images/IEC.png" target="_blank" class="text-light text-decoration-none mt-4 mb-2">IEC CERTIFICATE</a>
                </div>
            </div>
            <div class="col-md-6 p-2" data-aos="zoom-out"  data-aos-duration="2000">
                <div class="center-div d-flex flex-column align-items-center">
                  <a href="images/MSME.png" target="_blank" >  <img src="images/MSME.png" class="img-fluid imgcertificate" alt="" srcset="">  </a>
                  <a href="images/MSME.png" target="_blank" class="text-light text-decoration-none mt-4 mb-2">MSME CERTIFICATE</a>
                </div>
            </div>
            <div class="col-md-6 p-2" data-aos="zoom-out"  data-aos-duration="2000">
                <div class="center-div d-flex flex-column align-items-center">
                  <a href="images/GST.png" target="_blank">  <img src="images/GST.png" class="img-fluid imgcertificate" alt="" srcset="">  </a>
                  <a href="images/GST.png" target="_blank"class="text-light text-decoration-none mt-4 mb-2">GST CERTIFICATE</a>
                </div>
            </div>
            <div class="col-md-6 p-2" data-aos="zoom-out"  data-aos-duration="2000">
                <div class="center-div d-flex flex-column align-items-center">
