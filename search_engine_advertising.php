...
<html lang="en">
  ...
  <!--https://github.com/michalsnik/aos-->
    ...
    <div class="seabanner d-flex flex-column align-items-center justify-content-center">
      <h3 class="text-center" data-aos="zoom-out-up " data-aos-duration="2000">SEARCH ENGINE ADVERTISING</h3>
      <p class="text-white text-center" data-aos="zoom-out-down" data-aos-duration="2000">Our campaigns will get you relevant clicks and grow your business.</p>
    </div>

    <!--why seo matters-->
    <div class="seamatters container pt-5 pb-5" >
      <h3 class="text-center text-white" data-aos="slide-right" data-aos-duration="2000" data-aos-anchor-placement="top-center" >WHY SEARCH ENGINE ADVERTISING MATTERS ???</h3>
      <p class="text-center text-white" data-aos="slide-left" data-aos-duration="2500" data-aos-anchor-placement="top-center">Search engine advertising campaigns, also known as pay-per-click advertising, can be an effective way to increase your online findabilty and brand awareness. However, it is very easy to waste your time and money with online advertising if you have an ineffective advertising strategy, or no strategy at all. When this happens your results will be minimal, costs will be maximal, and it’s likely you will not reach your intended audience. Our search engine advertising campaigns are accurately targeted based on live data to ensure your advertising budget is being spent wisely to generate real, relevant, high-quality leads and sales. 

      </p>
      <div class="row mt-5 ">
        <div class="col-md-4 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3 class="text-white text-center"><i class="fa-solid fa-pencil text-danger"></i> Search</h3>
          <p  class="text-white text-center">Paying for a placement on a search engine results page can be valuable if you target the right keywords. We will do a keyword analysis to determine the most effective way to spend your money while staying ahead of your competition.</p>
   
        </div></div>

        <div class="col-md-4 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-arrows-rotate text-danger"></i> Remarketing</h3>
          <p  class="text-white text-center">There are several ways to use remarketing ads. It can either be via text ads or display ads.  We will help you to better understand where to reach your customers with remarketing to ensure a bigger conversion rate.</p>
  
        </div></div>

        <div class="col-md-4 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-image text-danger"></i> Display</h3>
          <p  class="text-white text-center">Display ads help to increase your brand awareness, since they are placed all over the internet. We will create the banner visuals, set up a display banner campaign, and implement specific targeting that will ensure an effective display banner campaign.</p>
    ...
    <div class="container">
      ...
      <p class="text-white" data-aos="slide-left" data-aos-duration="2100">The process begins with an analysis of your current online findability in reference to your competitors. We will conduct an effective keyword research analysis to ensure the correct keywords and audience are being targeted. With this information we will start creating your online advertising strategy.</p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2150">Step 2 Launch & Testing</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2200">Next, we will launch your campaign and begin measuring the results. We will continuously test and improve your campaigns to improve their effectiveness.

      </p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2200">Step 3 Optimizations & Result</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2250">Based on the results, we will continue to optimize your campaigns and implement your feedback in order to beat your competition.
