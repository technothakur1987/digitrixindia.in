...
<html lang="en">
  ...
  <!--https://github.com/michalsnik/aos-->
    ...
    <div class="seomatters container pt-5 pb-5" >
      <h3 class="text-center text-white" data-aos="slide-right" data-aos-duration="2000" data-aos-anchor-placement="top-center" >WHY SOCIAL MEDIA ADVERTISING MATTERS ???</h3>
      <p class="text-center text-white" data-aos="slide-left" data-aos-duration="2500" data-aos-anchor-placement="top-center">Paid advertisements on social media are a great way to reach new customers while re-engaging with existing ones. But only if it’s done effectively! Otherwise, you are throwing money into a void with a random chance of seeing results. There are many social platforms out there and the decision of where and how to run advertisements makes it even more complex. With our knowledge and expertise we can help you create (more) effective social ads. </p>
      <div class="row mt-5 ">
        <div class="col-md-3 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3 class="text-white text-center"><i class="fa-solid fa-tv text-danger"></i> Pixel Tracking Setup</h3>
          <p  class="text-white text-center">Tracking the behavior of your customers gives valuable insight into their purchase process. We will set up pixel tracking across your channels and measure the quality of the results, making adjustments as needed.</p>   
        </div></div>

        <div class="col-md-3 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-pen-nib text-danger"></i> Ad Creation</h3>
          <p  class="text-white text-center">For every social media network we will create unique advertisements. Because, what works for one network doesn’t necessarily work on others. This will make your ads stand out from the competition.  </p>
  
        </div></div>

        <div class="col-md-3 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-users text-danger"></i> Audience Segmentation</h3>
          <p  class="text-white text-center">Advertisements are a waste of money if they are shown to the wrong people. 
Therefore, we will segment your audience to ensure the right ads are displayed to the right people.</p>
    ...
    <div class="container">
      ...
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2050">Step 1 Map the Customer Journey</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2100">First we begin we the installation of all the trackers, to ensure we can measure the advertising results effectively. Then we start with the audience segmentation.</p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2150">Step 2 Create & Test Ads</p>
