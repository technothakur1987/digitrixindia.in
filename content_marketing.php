...
<html lang="en">
  ...
  <!--https://github.com/michalsnik/aos-->
    ...
    <div class="conbanner d-flex flex-column align-items-center justify-content-center">
      <h3 class="text-center" data-aos="zoom-out-up " data-aos-duration="2000">CONTENT MARKETING</h3>
      <p class="text-white text-center" data-aos="zoom-out-down" data-aos-duration="2000">Create content that connects.</p>
    </div>

    <!--why seo matters-->
    <div class="seomatters container pt-5 pb-5" >
      <h3 class="text-center text-white" data-aos="slide-right" data-aos-duration="2000" data-aos-anchor-placement="top-center" >WHY CONTENT MARKETING MATTERS ???</h3>
      <p class="text-center text-white" data-aos="slide-left" data-aos-duration="2500" data-aos-anchor-placement="top-center">Search engines like Google and Bing are not able to find your website if it does not contain content. Therefore content marketing is crucial because it will help potential customers find you while browsing the web. We understand that creating valuable and interesting content for your target audience can be challenging. That is where we step in, we combine your industry knowledge with our skills to write optimized SEO content for search engines. We use special tools to discover what your target audience is searching for online, this will help to ensure we write about topics that your customers are actually interested in. With these tools we can also measure how effective the content marketing is. </p>
      <div class="row mt-5 ">
        <div class="col-md-4 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3 class="text-white text-center"><i class="fa-solid fa-tv text-danger"></i> Blog Post Creation</h3>
          <p  class="text-white text-center">We write valuable, and SEO-friendly blog posts tailored to your goals. We create both short and long-form articles. We take care of the entire blog content process from writing to publishing.</p>   
        </div></div>

        <div class="col-md-4 mb-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-pen-nib text-danger"></i> Page Content</h3>
          <p  class="text-white text-center">The content on your landing pages directly impacts how Google interprets your website, and your conversions. We create on-site content that will reinforce your SEO and sales.  </p>
  
        </div></div>

        <div class="col-md-4 mb-md-3 d-flex justify-content-center align-items-center p-2" data-aos="zoom-in" data-aos-duration="2000" ><div>
          <h3  class="text-white text-center"><i class="fa-solid fa-users text-danger"></i> Social Media Content</h3>
          <p  class="text-white text-center">We can help you with social media management, and strategic content creation to help you grow your audience and reach new prospects. </p>
    ...
    <div class="container">
      ...
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2050">Step 1 Content Strategy Development</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2100">We will start by performing a SEO keyword research, and identifying content gaps and opportunities at various stages of your funnel. This information will help us to develop a content strategy that will add value to both your customers and your business.</p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2150">Step 2 Content Creation</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2200">Then we will write content according to the strategy we have developed. Once the content is ready, we will have a revision round. That way we can ensure that everybody is happy with the end result.</p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2200">Step 3 Implementation & Results</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2250">Once the changes are applied we will publish the content for you. This will result in an increase of your company’s online visibility,  brand awareness, and organic traffic. On top of that, your customers will view you as a thought leader in your industry. This will eventually translate itself into increased sales.</p>
