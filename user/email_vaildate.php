...
<html lang="en">
  <head>
    ...
    <title>Digitrix :Email Verification</title>
  </head>
  <body >
    <!--navbar-->
...
<div class="row pt-5">
    <h1 class="text-danger">Email Verification</h1>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="button" value="Validate" class="hoverdashboardbtn ms-2 px-2" style="background-color:black;">
