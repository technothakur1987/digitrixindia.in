...
<html lang="en">
  <head>
    ...
    <title> Web Development & Designs</title>
  </head>
  <body >
  ...
  <!--https://github.com/michalsnik/aos-->
    ...
    <div class="webdevbanner d-flex flex-column align-items-center justify-content-center">
      <h3 data-aos="zoom-out-up" data-aos-duration="2000">WEB DEVELOPMENT</h3>
      <p class="text-white" data-aos="zoom-out-down" data-aos-duration="2000">Build a website with marketing in mind.</p>
    </div>

    <!--why seo matters-->
    <div class="webdevbannermatters container pt-5 pb-5" >
      <h3 class="text-center text-white" data-aos="slide-right" data-aos-duration="2000" data-aos-anchor-placement="top-center" >WHY WEB DEVELOPMENT & DESIGN MATTERS ???</h3>
      <p class="text-center text-white" data-aos="slide-left" data-aos-duration="2500" data-aos-anchor-placement="top-center">With our expertise and knowledge, we are able to build visually appealing, high-quality WordPress websites that drive conversions to help grow your business. We work closely with you to develop a deep understanding of your company’s goals and industry in order to implement elements that will engage your visitors from the moment they come on your site.</p>
    ...
    <div class="container">
      ...
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2050">Step 1 Planning</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2100">First, we will sit down with you and your team to evaluate the current state of your website. We will discuss your goals, and decide what needs to be done. After this will develop a plan, in which we determine the structure and overall aesthetic of your new site. </p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2150">Step 2 Implementation & Design</p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2200">We start implementing the planned changes to your site and incorporating the new design. During this process we will have revision rounds to ensure the best final result. 



      </p>
      <p class="text-white fw-bold" data-aos="slide-left" data-aos-duration="2200">Step 3 Delivery </p>
      <p class="text-white" data-aos="slide-left" data-aos-duration="2250">Changes to the site will be published and the website will go live! We will continue to monitor the performance of your site and make adjustments as needed to ensure optimal results.
