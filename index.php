...
<div class="container-fluid bg-danger text-white text-center pt-2 pb-0 navbar fixed-top">
   ...
   <!--text-info-->
    <div class="indexinfo ">
      ...
      <h3 class="text-white text-center mb-3" data-aos="fade-up"  data-aos-duration="3000">DIGITAL MARKETING & WEB DEVELOPMENT AGENCY</h3>
      <p class="text-white text-center mt-3 mb-3" data-aos="fade-down"  data-aos-duration="3000">Worldwide we help businesses gain more leads and brand awareness by reassessing and improving their online presence. We provide unique web design combined with an extensive search engine optimization, online advertising and content strategy to ensure business growth.</p>
   ...
   <div class="indexServices">
    <h3 class="text-center text-white" data-aos="fade-up" data-aos-duration="2000">DIGITAL MARKETING SERVICES</h3>
   ...
   <!--fixedbanner-->
   <div class="indexfixedbanner mt-5 mb-5 d-flex flex-column justify-content-center align-items-center pt-5 pb-5">
    <h3 class="text-center text-white">OUR SKILLS</h3>
    <p class="text-center text-white">Worldwide we help businesses drive more leads by reassessing & reinvigorating their online presence. We provide unique web design combined with an extensive search engine optimization, online advertising and content strategy to ensure business growth.</p>
    <a href="tel:8109184732" class="btn btn-danger w-25 text-white py-3 mt-2" data-aos="fade-down" data-aos-duration="2000" ><i class="fa-solid fa-phone "></i> CALL US...</a> 
  </div> 

  <hr class="bg-danger mx-2 border border-danger ">
  <hr class="bg-danger mx-2 border border-danger">
  ...
  <div class="our-clients pt-3 pb-3" >
    ...
    <div class="row" data-aos="zoom-in" data-aos-duration="3000"style="overflow:hidden;">
      ...
      <div class="col-md-2 mb-3 text-center p-2 d-flex justify-content-center align-items-center" data-aos="fade-down" data-aos-duration="3000"><div class=" text-center"><img src="images/oc4.png" class="img-fluid"></div></div>
      <div class="col-md-2 mb-3 text-center p-2 d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-duration="3000"><div class=" text-center"><img src="images/oc5.png" class="img-fluid"></div></div>
      <div class="col-md-2 mb-3 text-center p-2 d-flex justify-content-center align-items-center" data-aos="fade-down" data-aos-duration="3000"><div class=" text-center"><img src="images/oc9.png" class="img-fluid">  </div></div>
