...
<html lang="en">
 ...
 <div class="d-flex justify-content-center align-items-center">
   <form class="p-5 pt-5 mt-5">
        <div class="row pt-5">
    <h1 class="text-danger">Log-In Here</h1>
    ...
    <div class="col-md-12">
        ...
        <a href="email_vaildate.php" class="text-decoration-none">Forget Password?</a>
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="button" value="Login" class="hoverdashboardbtn ms-2 px-2" style="background-color:black;">

        </div>
        <span class="text-white">New User Create Account...<a href="user_registration.php" class="text-decoration-none">Register here</a></span>
